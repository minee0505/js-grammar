...
const r1 = userList.findIndex(user => user.job === '추노')
console.log(r1)
console.log('=========================================')
...
const r2 = userList.find(user=> user.hobbies.includes('독서'))
console.log(r2)
console.log('=========================================')
// some() : 콜백조건에 맞는 데이터가 하나라도 있는지 여부 확인
// every() : 콜백조건에 모든 데이터가 맞는지 확인

// 급여가 500만원 이상인 회원이 한명이라도 있는가?
const r3 = userList.some(user => user.salary >= 5000000)

console.log(r3)
console.log('=========================================')

// 모든 회원이 서울에 사는가?
const r4 = userList.every(user => user.address === '서울')
console.log(r4)
console.log('=========================================')
